...
def main():
    ...
    if args.SFT:
        ...
        folder_path = f'../results_dynamic/{dataset_name}_ICL_{learning_setting}{split_name}_{args.type}{model_name}' if args.ICL_only else \
    ...
    print(folder_path)
    EM_dict, f1_score_dict, recall_dict, num_question_cat = compute_metrics(folder_path, args.SFT, args.ppl, args.prompt_format, dataset_name)
